    ...
    >
      <div className="w-full rounded-2xl border border-border bg-card p-6 flex flex-col gap-6 shadow-xs">
        ...
        <div>
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-[8px] border-[1.5px] border-accent px-5 py-1.5 text-[14px] font-semibold tracking-[-0.01em] text-accent transition-colors hover:bg-accent/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
          >
            View Candidates
          </button>
        </div>
